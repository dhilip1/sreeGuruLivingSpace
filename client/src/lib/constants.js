...
exports.CONTACT_INFO = exports.SOCIAL_LINKS = exports.TIME_SLOTS = exports.COURSE_INTEREST_OPTIONS = exports.CONSULTATION_TYPES = exports.ABOUT_FEATURES = exports.TESTIMONIALS = exports.COURSES = exports.SERVICES = exports.SITE_DESCRIPTION = exports.SITE_TITLE = void 0;
exports.SITE_TITLE = "Sree Guru Living Space Science";
exports.SITE_DESCRIPTION = "Om Shreem Namah !  Welcome to Sree Guru Living Space Science, your trusted guide to harmonizing your living and working spaces with the ancient wisdom of Vasthu & Astrology.";
exports.SERVICES = [
    {
        id: 1,
...
exports.ABOUT_FEATURES = [
    {
        title: "Tradition & Heritage",
        description: "Rooted in ancient texts dating back thousands of years.",
        icon: "star"
    },
    {
        title: "Balance & Harmony",
        description: "Creating equilibrium between spaces and natural elements.",
        icon: "scale"
    },
    {
        title: "Energy Flow",
        description: "Optimizing the flow of positive energy in living spaces.",
        icon: "home"
    },
    {
        title: "Cosmic Connection",
        description: "Aligning human spaces with cosmic energies and rhythms.",
        icon: "sun"
    }
];
exports.CONSULTATION_TYPES = [
    { label: "Home & Property Consultation", value: "residential" },
    { label: "Business & Office Consultation", value: "commercial" },
    { label: "Personal Astrology Reading", value: "personal" }
];
exports.COURSE_INTEREST_OPTIONS = [
